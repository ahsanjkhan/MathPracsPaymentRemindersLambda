...
IMPORTED_TUTOR_PAYMENT_LAMBDA_ENV_VAR_KEY_SESSIONS_TABLE_NAME = 'SESSIONS_TABLE_NAME'
IMPORTED_TUTOR_PAYMENT_LAMBDA_ENV_VAR_KEY_STUDENTS_TABLE_NAME = 'STUDENTS_TABLE_NAME'
IMPORTED_TUTOR_PAYMENT_LAMBDA_ENV_VAR_KEY_STUDENTS_METADATA_TABLE_NAME = 'STUDENTS_METADATA_TABLE_NAME'
IMPORTED_TUTOR_PAYMENT_LAMBDA_ENV_VAR_KEY_TUTORS_TABLE_NAME = 'TUTORS_TABLE_NAME'
IMPORTED_TUTOR_PAYMENT_LAMBDA_ENV_VAR_KEY_TUTORS_METADATA_TABLE_NAME = 'TUTORS_METADATA_TABLE_NAME'
IMPORTED_TUTOR_PAYMENT_LAMBDA_ENV_VAR_KEY_DISCORD_API_SECRETS_ARN = 'IMPORTED_DISCORD_API_SECRETS_ARN'
...
# DynamoDB operations
DYNAMODB_UPDATE_EXPRESSION = 'SET processed_discord = :val'
